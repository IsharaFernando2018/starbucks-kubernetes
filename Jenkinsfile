pipeline {
    ...
    stages {
        ...
        stage('checkout') {
            steps {
                git branch: 'main', url: 'https://github.com/IsharaFernando2018/starbucks-kubernetes.git'
            }
        }
        ...
        //               sh "docker tag starbucks ferdi2018/starbucks:latest "
        //               sh "docker push ferdi2018/starbucks:latest "
        //             }
        //         }
        //     }
        // }
